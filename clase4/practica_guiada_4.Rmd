...
#######OMITIR ESTAS FORMULAS: ESTABAN ARMADAS CON LA MATRIZ AL REVÉS#####
...
```
 ...
 - De los casos positivos (que efectivamente realizan trabajo doméstico), el modelo predice bien un `r scales::percent(sens,accuracy = 0.01) `.     
 - De los casos negativos (que no realizan trabajo doméstico), el modelo predice bien un `r scales::percent(spec,accuracy = 0.01) `.    
 - De los casos que son clasificados como positivos, sólo un `r scales::percent(prec,accuracy = 0.01)` . lo son.
