...
El gráfico siguiente muestra dos variables (x e y):
...
Definimos este valor como la suma total de cuadrados (SST: total sum of squares), calculada
...
al cuadrado (SSE: sum of squared errors), calculada usando la fórmula a continuación, donde
...
![Suma total de cuadrados (SST) en rojo y Suma de los residuos al cuadrado (SSE) en azul](https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Coefficient_of_Determination.svg/600px-Coefficient_of_Determination.svg.png)
