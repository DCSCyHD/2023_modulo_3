...
Otro paquete que permite revisar los supuestos de los modelos es la función check_model(), incluida en easystats. En este caso, se utiliza para revisar el VIF:
...
Veamos los coeficientes y la significatividad. Para extraer los resultados después de aplicar fit a un workflow usamos la función `extract_fit_engine()`, que nos devuelve el objeto `lm` subyacente.
