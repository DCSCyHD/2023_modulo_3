...
$$ y \approx \beta_{0} + \beta_{1}X_{1} + \beta_{2}X_{2} + \beta_{3}X_{3} + ... + \beta_{n}X_{n} + \epsilon$$ 
...
$$ Y \approx \beta_{0} + \beta_{1}X_{1} + \beta_{2}X_{2} + \epsilon$$
...
$$ Y = (\beta_{0} + \beta_{2}) + \beta_{1}X_{1}$$
...
$$ Y \approx \beta_{0} + \beta_{1}X_{1} + \beta_{2}X_{2} + \beta_{3}X_{1}X_{2} + \epsilon$$
...
$$ Y = \beta_{0} + \beta_{1}X_{1} + \beta_{2} + \beta_{3}X_{1} $$
$$ Y = (\beta_{0} + \beta_{2}) + (\beta_{1} + \beta_{3})X_{1}$$
