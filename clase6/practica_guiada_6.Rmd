...
Hagamos otro ejercicio de predicción un poco distinto. Queremos predecir el **ingreso individual** a partir de las horas de trabajo, el sexo y la cantidad de menores en el hogar.    

¿Cómo hacemos para saber hasta que grado de polinomio nos conviene avanzar?. El *tuneo* ("espanglish" de tune: afinación) de los hiperparámetros consiste en evaluar, dentro de un rango especificado, cual es el mejor valor posible para setear el mismo en términos de como performa el modelo. 
```{r}
