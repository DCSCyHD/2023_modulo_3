...
# Práctica (en clase)     
 - Tomando solo las variables del modelo recién visto para K = 5, estimen 2 modelos más:
    - Un KNN con K = 3
    - Una regresión logística (como la de la clase pasada)  
 - Comparen el accuracy (tanto en training como en testing) de los 3 modelos
