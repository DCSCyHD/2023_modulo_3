...
La correlación es una forma "normalizada" de la _covarianza_, para que esté entre -1 y 1. Es decir que si dos variables tienen una relación lineal fuerte y positiva, podemos decir que tienen eleveda correlación o elevada covarianza. Noten que el nombre "covarianza" viene de que se calcula muy parecido a la varianza (la varianza es, de hecho, la covarianza de una variable consigo misma).
